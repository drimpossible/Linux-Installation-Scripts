...
alias egrep='egrep --color=auto'
alias ls='ls --color=auto'
alias ll="ls -lhA | less"
alias ..="cd .."
alias du="ncdu"
alias s="find . -name"
alias df="pydf -Tha --total"
alias pg="ps aux | grep -v grep | grep -i -e VSZ -e" #Run this as pg bash to search for bash processes
alias mkdir="mkdir -pv"
alias wget="wget -c"
alias sbrc="source ~/.bashrc 2>~/basherror.txt"
